...
import { AssetLocationQueryOptions } from "@/modules/fms/types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: AssetLocationQueryOptions
  updateParams?: (newParams: Partial<AssetLocationQueryOptions>) => void
  onClear?: () => void
}

export default function AssetLocationTableToolbar<
