...
import CategoriesTable from "@/modules/crm/components/containers/categories/table"

const CategoryFormDrawerView = dynamic(
  () =>
    import(
      "@/modules/crm/components/containers/categories/category-form-drawer-view"
    ),
  {
    ssr: false,
  }
