...
import { useRequisitionApprovalById } from "@/modules/scm/hooks/procurement/requisition/use-requisition-approval"
...
export default function RequisitionApprovalDrawerView({
  initialData,
}: {
  ...
  const { data, isLoading } = useRequisitionApprovalById(
    Number(initialData?.id)
  )

  // Use useMemo to memoize any derived data if needed
  const memoizedData: RequisitionApproval | undefined = useMemo(
    () => data as RequisitionApproval,
    [data]
  )
  ...
  return (
    <div className="flex h-full flex-col">
      <DrawerHeader
        heading={t("text-requisition-approval-details")}
        onClose={closeDrawer}
