...
import { PaymentTermsQueryOptions } from "@/modules/scm/types/procurement/supplier/payment-terms-types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: PaymentTermsQueryOptions
  updateParams?: (newParams: Partial<PaymentTermsQueryOptions>) => void
  onClear?: () => void
}

export default function PaymentTermsTableToolbar<
