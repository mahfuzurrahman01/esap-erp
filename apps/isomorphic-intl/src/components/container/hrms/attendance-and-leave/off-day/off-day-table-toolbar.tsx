...
import { AttendanceQueryOptions } from "@/types/hrms/attendance-and-leave/attendance.types"
import { LeaveType } from "@/types/hrms/attendance-and-leave/leave-type.types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: AttendanceQueryOptions
  updateParams?: (newParams: Partial<AttendanceQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const isFiltered = Boolean(params?.search || params?.leaveTypeId)
...
export default function OffDayTableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
