...
export default function PaymentAccounts({
  ...
  const { coaOptions, coaList, searchCOA, isCOALoading } = coa
            ...
            value={
              value && coaOptions
                ? coaOptions.find(
                  ...
                  value: value,
                  label: coaList.data.find((coa: any) => coa.id === value)?.accountNameWithAbbr ||
                    coaList.data.find((coa: any) => coa.id === value)?.accountName ||
                    "Selected Account"
                } : null)
                : null
            }
