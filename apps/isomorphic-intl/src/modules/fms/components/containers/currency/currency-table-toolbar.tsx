...
import { useBulkDeleteCurrency } from "@/modules/fms/hooks/use-currency"
import { CurrencyQueryOptions } from "@/modules/fms/types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: CurrencyQueryOptions
  updateParams?: (newParams: Partial<CurrencyQueryOptions>) => void
  onClear?: () => void
}
