...
import { useBulkDeleteGoals } from "@/hooks/hrms/appraisal/use-goals"
...
export default function GoalsTableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
