...
import { ActionIcon, Button, Drawer, Input, Title } from "rizzui"

import { ToggleColumns } from "@/components/base/table-shared-components"
...
export default function TableFilter({
  ...
  const [openDrawer, setOpenDrawerView] = useState(false)
