...
import { CostManagementQueryOptions } from "@/modules/scm/types/feature-reports/cost-management"
import dayjs from "dayjs"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: CostManagementQueryOptions
  updateParams?: (newParams: Partial<CostManagementQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const { product, workCenter } = useSCMSharedDataHook([
    "product",
    "workCenter",
  ])
...
export default function CostManagementReportTableToolbar<
