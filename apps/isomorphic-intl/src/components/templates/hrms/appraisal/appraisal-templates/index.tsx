...
import AppraisalTemplatesTable from "@/components/container/hrms/appraisals/appraisal-templates/appraisal-templates-table"
import { Button } from "@/components/ui"
import { messages } from "@/config/messages"
import { routes } from "@/config/routes"

const pageHeader = {
  title: "text-appraisal-templates",
  breadcrumb: [
    {
    ...
    <div>
      <PageHeader title={pageHeader.title} breadcrumb={pageHeader.breadcrumb}>
        <div className="mt-6 flex justify-end md:mt-0">
          <Link href={routes.hr.createAppraisalTemplate}>
