...
import { useItemTableColumns } from "./use-item-column"

export default function ItemTable() {
  const { direction } = useDirection()
  const deleteItem = useDeleteItem()
  const deleteItemBulk = useBulkDeleteItem()
  const columns = useItemTableColumns()

  const { params, updateParams } = useQueryParams<ItemQueryOptions>({
    params: [
      {
        key: "search",
        defaultValue: "",
  ...
  const { handleDeleteRow, handleMultipleDelete } = useTableDelete<Item>({
    deleteMutation: deleteItem.mutate,
      ...
      <WidgetCard
        ...
        <DndContext
          ...
          <MainTable
            ...
            isLoading={
              isLoading || deleteItem.isPending || deleteItemBulk.isPending
            }
            components={{
