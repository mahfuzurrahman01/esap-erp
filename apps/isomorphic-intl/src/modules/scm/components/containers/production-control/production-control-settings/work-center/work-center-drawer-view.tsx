...
import { useWorkCenterById } from "@/modules/scm/hooks/production-control/work-order-tracking/use-work-center"
import { WorkCenter } from "@/modules/scm/types/production-control/work-order-tracking/work-center-types"

export default function WorkCenterDrawerView({
  initialData,
}: {
  ...
  const { data, isLoading } = useWorkCenterById(Number(initialData?.id))

  // Use useMemo to memoize any derived data if needed
  const memoizedData: WorkCenter | undefined = useMemo(
    () => data as WorkCenter,
    [data]
  )
  ...
  return (
    <div className="flex h-full flex-col">
      <DrawerHeader
        heading={t("text-work-center-details")}
        onClose={closeDrawer}
