...
export default function CategoriesTable() {
  ...
  const deleteItemBulk = useBulkDeleteCategory()
  const columns = useColumn()
  const { params, updateParams } = useQueryParams<CategoryQueryOptions>({
    params: [
      {
        key: "search",
        defaultValue: "",
  ...
  const { data, isLoading, isPending } = useCategoryList({
  ...
  const { handleDeleteRow, handleMultipleDelete } =
    useTableDelete<CategoryList>({
      deleteMutation: deleteCategory.mutate,
