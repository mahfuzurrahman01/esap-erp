...
import { useBulkDeleteEmployeeType } from "@/hooks/hrms/employee/use-employee-type"
import { EmployeeTypeQueryOptions } from "@/types/hrms/employee/employee-types.types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: EmployeeTypeQueryOptions
  updateParams?: (newParams: Partial<EmployeeTypeQueryOptions>) => void
  onClear?: () => void
}

export default function EmployeeTypesTableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const {
    mutateAsync: bulkDeleteEmployeeType,
    isSuccess: deleteSuccess,
    isPending: isDeletePending,
  } = useBulkDeleteEmployeeType()
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteEmployeeType(selectedIds)
  }
