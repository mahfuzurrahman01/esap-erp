...
import { useBulkDeleteJobPosition } from "@/hooks/hrms/employee/use-job-positions"
import { JobPositionQueryOptions } from "@/types/hrms/employee/job-positions.types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: JobPositionQueryOptions
  updateParams?: (newParams: Partial<JobPositionQueryOptions>) => void
  onClear?: () => void
}
...
export default function JobPositionTableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const {
    mutateAsync: bulkDeleteJobPosition,
    isSuccess: deleteSuccess,
    isPending: isDeletePending,
  } = useBulkDeleteJobPosition()
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteJobPosition(selectedIds)
  }
