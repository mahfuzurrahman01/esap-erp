...
import { useBulkDeleteTaxRule } from "@/modules/fms/hooks/use-tax-rule"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: TaxRuleQueryOptions
  updateParams?: (newParams: Partial<TaxRuleQueryOptions>) => void
  onClear?: () => void
}
...
export default function TaxRuleTableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const { mutateAsync: bulkDeleteTaxRule, isPending: isDeletePending } =
    useBulkDeleteTaxRule()
