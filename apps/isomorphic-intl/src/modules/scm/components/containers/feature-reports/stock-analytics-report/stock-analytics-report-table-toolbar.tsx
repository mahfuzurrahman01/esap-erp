...
import { StockAnalyticsReportQueryOptions } from "@/modules/scm/types/feature-reports/stock-analytics-report"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: StockAnalyticsReportQueryOptions
  updateParams?: (newParams: Partial<StockAnalyticsReportQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const { product } = useSCMSharedDataHook(["product"])
  const { productOptions, isProductsLoading } = product

  const isFiltered = Boolean(
    params?.search || params?.productName || params?.fromDate || params?.toDate
  )
  ...
  return (
    <>
      ...
      <DateFiled
        ...
        value={params?.fromDate ? new Date(params.fromDate) : null}
        onChange={(e: any) =>
      ...
      <DateFiled
        ...
        value={params?.toDate ? new Date(params.toDate) : null}
...
export default function StockAnalyticsReportTableToolbar<
