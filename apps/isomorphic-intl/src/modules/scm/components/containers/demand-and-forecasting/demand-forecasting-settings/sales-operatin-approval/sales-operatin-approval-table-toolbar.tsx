...
import { SalesOperationApprovalQueryOptions } from "@/modules/scm/types/demand-and-forecasting/sales-operation-plan/sales-operation-approval-types"
...
interface TableToolbarProps<T extends Record<string, any>> {
  ...
  params?: SalesOperationApprovalQueryOptions
  updateParams?: (
    newParams: Partial<SalesOperationApprovalQueryOptions>
  ) => void
  onClear?: () => void
}
  ...
  return (
    <>
      ...
      <DateFiled
        ...
        value={params?.approvalDate ? dayjs(params.approvalDate).toDate() : null}
...
export default function SalesOperationApprovalTableToolbar<
