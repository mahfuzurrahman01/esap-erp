...
import { typeOptions } from "@/data/crm/opportunities"
import { OpportunityQueryOptions } from "@/modules/crm/types/opportunity"

import { dropdownStyles } from "../meeting/meeting-css"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: OpportunityQueryOptions
  updateParams?: (newParams: Partial<OpportunityQueryOptions>) => void
  onClear?: () => void
}
  ...
  return (
    <>
      <Select
        ...
        options={typeOptions}
        value={
          typeOptions.find((option) => option.label === params?.type) || null
        }
