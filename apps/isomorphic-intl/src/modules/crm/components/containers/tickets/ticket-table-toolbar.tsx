...
import { statusOptions } from "@/data/crm/campaign"
import { TicketQueryOptions } from "@/modules/crm/types/ticket"
...
interface TableToolbarProps<T extends Record<string, any>> {
  ...
  params?: TicketQueryOptions
  updateParams?: (newParams: Partial<TicketQueryOptions>) => void
  onClear?: () => void
}
  ...
  return (
    <>
      <Select
        ...
        value={
          statusOptions.find(
            (option: any) => option.label === params?.status
          ) || null
        }
...
export default function TicketTableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
