...
export function CustomTooltip({
  ...
  return (
    ...
    >
      <Text className="label mb-0.5 block bg-gray-100 p-2 px-2.5 text-center font-barlow text-xs font-semibold capitalize text-gray-600 dark:bg-gray-200/60 dark:text-gray-700">
        {label}
      </Text>
