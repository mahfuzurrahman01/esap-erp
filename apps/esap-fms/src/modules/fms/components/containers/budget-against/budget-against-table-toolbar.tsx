...
import { useBulkDeleteBudgetAgainst } from "@/modules/fms/hooks/use-budget-against"
import { BudgetAgainstQueryOptions } from "@/modules/fms/types/budget-against"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: BudgetAgainstQueryOptions
  updateParams?: (newParams: Partial<BudgetAgainstQueryOptions>) => void
  onClear?: () => void
}
...
export default function BudgetAgainstTableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const {
    mutateAsync: bulkDeleteBudgetAgainst,
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteBudgetAgainst(selectedIds)
  }
