...
import { CurrencyExchangeQueryOptions } from "@/modules/fms/types"
import { useBulkDeleteCurrencyExchange } from "@/modules/fms/hooks/use-currency-exchange"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: CurrencyExchangeQueryOptions
  updateParams?: (newParams: Partial<CurrencyExchangeQueryOptions>) => void
  onClear?: () => void
}
...
export default function CurrencyExchangeTableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
  ...
  const {
    mutateAsync: bulkDeleteCurrency,
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteCurrency(selectedIds)
  }
