...
import { MaterialRequirementsPlanningQueryOptions } from "@/modules/scm/types/production-control/materials-requirements-planning/material-requirements-planning-types"

import { materialAvailabilityStatusOptions } from "./status-option"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: MaterialRequirementsPlanningQueryOptions
  updateParams?: (
    newParams: Partial<MaterialRequirementsPlanningQueryOptions>
  ) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const isFiltered = Boolean(params?.search || params?.approvalStatus)
  ...
  return (
    <>
      <Select
        ...
        value={
          materialAvailabilityStatusOptions.find(
...
export default function MaterialAvailabilityTableToolbar<
