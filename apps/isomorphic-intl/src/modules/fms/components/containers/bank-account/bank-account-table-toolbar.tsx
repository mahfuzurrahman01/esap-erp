...
import { useBulkDeleteBankAccount } from "@/modules/fms/hooks/use-bank-account"
import {
...
interface TableToolbarProps<T extends Record<string, any>> {
  ...
  params?: BankAccountQueryOptions
  updateParams?: (newParams: Partial<BankAccountQueryOptions>) => void
  onClear?: () => void
}
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const { mutateAsync: bulkDeleteBankAccount, isPending: isDeletePending } =
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteBankAccount(selectedIds)
  }
