...
import { useBulkDeleteAssetDepreciation } from "@/modules/fms/hooks/use-asset-depreciation-schedule"
import { AssetDepreciationQueryOptions } from "@/modules/fms/types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: AssetDepreciationQueryOptions
  updateParams?: (newParams: Partial<AssetDepreciationQueryOptions>) => void
  onClear?: () => void
}
...
export default function AssetDepreciationTableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const {
    mutateAsync: bulkDeleteAssetDepreciation,
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteAssetDepreciation(selectedIds)
  }
