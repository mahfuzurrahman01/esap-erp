...
interface TableToolbarProps {
  params?: GeneralLedgerQueryOptions
  updateParams?: (newParams: Partial<GeneralLedgerQueryOptions>) => void
  onClear?: () => void
  filterValue?: string
    ...
    <div className="flex items-center justify-between">
      ...
      <div className="flex shrink-0 grow-0 basis-auto items-center gap-4">
        <Button
          ...
          variant={"outline"}
          className={cn(
            "h-10 rounded-lg border-gray-500/20 pe-3 ps-2.5 text-title dark:text-gray-0",
