...
import banner from "@public/auth/banner.png"
        ...
        <div className="grid h-full min-h-screen grid-cols-1 gap-4 lg:grid-cols-4">
          ...
          <div className="col-span-1 hidden items-center justify-center bg-gray-200 dark:bg-gray-800 lg:flex">
            <div className="text-center">
              <Logo className="h-[75px] w-[200px] px-2 dark:text-title lg:absolute lg:left-0 lg:top-0" />
              <h2 className="text-3xl">{t("auth-hi-welcome-back")}</h2>
              <p className="mb-10 mt-6 text-base">
                {t("auth-more-effectively-with-optimized-workflows")}
              </p>
              <Image
                src={banner}
