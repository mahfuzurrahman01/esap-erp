...
import StocksTable from "@/modules/crm/components/containers/stocks/table"

const StockFormDrawerView = dynamic(
  () =>
    import("@/modules/crm/components/containers/stocks/stock-form-drawer-view"),
  {
    ssr: false,
  }
)
