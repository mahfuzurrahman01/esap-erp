...
import { useBulkDeleteWorkingSchedule } from "@/hooks/hrms/employee/use-work-schedule"
import { WorkingScheduleQueryOptions } from "@/types/hrms/employee/working-schedule.types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: WorkingScheduleQueryOptions
  updateParams?: (newParams: Partial<WorkingScheduleQueryOptions>) => void
  onClear?: () => void
}

export default function WorkingScheduleTableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const {
    mutateAsync: bulkDeleteWorkSchedule,
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteWorkSchedule(selectedIds)
  }
