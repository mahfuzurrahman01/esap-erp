...
import { FreightQueryOptions } from "@/modules/scm/types/logistics-and-transport/freight/freight-types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: FreightQueryOptions
  updateParams?: (newParams: Partial<FreightQueryOptions>) => void
  onClear?: () => void
}
  ...
  return (
    <>
      ...
      <Input
        type="text"
        className="min-w-[242px]"
        placeholder={t("table-text-origin")}
        value={params?.origin}
        onClear={() => updateParams?.({ origin: "" })}
