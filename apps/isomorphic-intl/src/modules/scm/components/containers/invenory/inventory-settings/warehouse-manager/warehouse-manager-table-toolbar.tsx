...
import { WarehouseManagerQueryOptions } from "@/modules/scm/types/inventory/warehouse/warehouse-manager-types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: WarehouseManagerQueryOptions
  updateParams?: (newParams: Partial<WarehouseManagerQueryOptions>) => void
  onClear?: () => void
}

export default function WarehouseManagerTableToolbar<
