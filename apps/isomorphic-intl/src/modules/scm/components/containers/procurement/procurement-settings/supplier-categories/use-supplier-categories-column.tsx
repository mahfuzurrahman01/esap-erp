...
import SupplierCategoriesFormDrawerView from "./supplier-categories-drawer-form";
import SupplierCategoriesDrawerView from "./supplier-categories-drawer-view";





const columnHelper = createColumnHelper<SupplierCategory>()

export const useSupplierCategoriesTableColumns = () => {
  ...
  const columns = useMemo(
              ...
              <div className="flex items-center justify-end gap-3 pe-3">
                <EditIconButton
                  onClick={() =>
                    openDrawer({
                      view: (
                        <SupplierCategoriesFormDrawerView
                          isEditForm
    ...
    [t, name, description, editSupplierCategory, viewSupplierCategory]
  )
