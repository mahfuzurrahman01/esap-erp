...
import {
  ...
  useSaudiEmployeeMonthlyReport,
} from "@/hooks/hrms/employee/use-employee-report"
...
export default function SaudiEmployeeReportDashboard() {
  ...
  const { data, isLoading } = useSaudiEmployeeMonthlyReport({
