...
import { TargetQueryOptions } from "@/modules/crm/types/target"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: TargetQueryOptions
  updateParams?: (newParams: Partial<TargetQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const isFiltered = Boolean(
    params?.search || params?.title || params?.type || params?.targetValue
  )
...
export default function TargetTableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
