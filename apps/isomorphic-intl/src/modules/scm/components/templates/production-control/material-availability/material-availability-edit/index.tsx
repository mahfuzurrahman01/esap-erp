...
const pageHeader = {
  title: "text-edit-material-availability",
  breadcrumb: [
    {
    ...
    {
      name: "text-edit-material-availability",
    },
  ],
}

export default function EditMaterialAvailabilityPage() {
  const { id } = useParams()
  return (
    <>
      <PageHeader title={pageHeader.title} breadcrumb={pageHeader.breadcrumb} />
      <CreateEditMaterialAvailability id={Number(id)} mode="edit" />
    </>
  )
}
