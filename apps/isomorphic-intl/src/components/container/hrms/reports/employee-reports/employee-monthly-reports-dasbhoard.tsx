...
import { useEmployeeMonthlyReport } from "@/hooks/hrms/employee/use-employee-report"
...
export default function EmployeeMonthlyReportsDasbhoard() {
  ...
  const { data, isLoading } = useEmployeeMonthlyReport({
