...
export default function BerylliumLeftSidebarFixed() {
  ...
  return (
    <aside className="fixed start-0 top-0 z-[99] hidden h-screen w-[88px] flex-col items-center gap-10 border-r border-gray-500/20 bg-background px-1 py-3.5 dark:bg-gray-900 xl:flex">
      <ActionIcon
