...
import { useBulkDeleteEmployeeContracts } from "@/hooks/hrms/payroll/use-employee-contract"
import { EmployeeContractQueryOptions } from "@/types/hrms/payroll/employee-contract.types"

interface EmployeeContractTableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: EmployeeContractQueryOptions
  onClear?: () => void
  updateParams?: (newParams: Partial<EmployeeContractQueryOptions>) => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  onClear,
}: EmployeeContractTableToolbarProps<T>) {
...
export default function EmployeeContractTableToolbar<
  TData extends Record<string, any>,
>({ table, params, updateParams }: EmployeeContractTableToolbarProps<TData>) {
  const t = useTranslations("table")
  ...
  const {
    mutateAsync: bulkDeleteEmployeeContracts,
    isSuccess: deleteSuccess,
    isPending: isDeletePending,
  } = useBulkDeleteEmployeeContracts()
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteEmployeeContracts(selectedIds)
  }
