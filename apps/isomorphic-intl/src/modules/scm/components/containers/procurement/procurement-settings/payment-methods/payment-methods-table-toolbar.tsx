...
import { PaymentMethodQueryOptions } from "@/modules/scm/types/procurement/supplier/payment-method-types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: PaymentMethodQueryOptions
  updateParams?: (newParams: Partial<PaymentMethodQueryOptions>) => void
  onClear?: () => void
}
