...
import { MachineQueryOptions } from "@/modules/scm/types/production-control/work-order-tracking/machine-types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: MachineQueryOptions
  updateParams?: (newParams: Partial<MachineQueryOptions>) => void
  onClear?: () => void
}

export default function MachineTableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
