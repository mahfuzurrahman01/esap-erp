...
const QuotationPdfDocument = ({ data, quotationDetails }:any) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.subtitle}>Quotation #{data.quotationNo}</Text>
          </View>
          <View>
            <Text style={styles.subtitle}>Title: {data.title}</Text>
            <Text style={styles.subtitle}>Expire Date: {formatDate(data.expiryDate)}</Text>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          {quotationDetails?.map((item:any, index:number) => (
