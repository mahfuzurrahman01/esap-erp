...
import { ZatcaCategoryQueryOptions } from "@/modules/fms/types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: ZatcaCategoryQueryOptions
  updateParams?: (newParams: Partial<ZatcaCategoryQueryOptions>) => void
  onClear?: () => void
}
...
export default function ZatcaCategoryableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const { mutateAsync: bulkDeleteZatkaCategory, isPending: isDeletePending } = useBulkDeleteZatcaCategory()
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteZatkaCategory(selectedIds)
  }
