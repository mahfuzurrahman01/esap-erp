...
import { useBulkDeleteEmploymentType } from "@/hooks/hrms/employee/use-employment-type"
import { EmploymentTypeQueryOptions } from "@/types/hrms/employee/employment-types.types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: EmploymentTypeQueryOptions
  updateParams?: (newParams: Partial<EmploymentTypeQueryOptions>) => void
  onClear?: () => void
}

export default function EmploymentTypesTableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const {
    mutateAsync: bulkDeleteEmploymentTypes,
    isSuccess: deleteSuccess,
    isPending: isDeletePending,
  } = useBulkDeleteEmploymentType()
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteEmploymentTypes(selectedIds)
  }
