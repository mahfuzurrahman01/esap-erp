...
import { ItemUnit, ItemUnitPaginator, ItemUnitQueryOptions } from "@/modules/scm/types/procurement/requisition/item-unit-types";
...
export function useCreateUnit() {
  ...
  return useMutation({
    ...
    onMutate: async (newUnit) => {
      ...
      const previousUnit = queryClient.getQueryData<ItemUnitPaginator>(queryKey)
