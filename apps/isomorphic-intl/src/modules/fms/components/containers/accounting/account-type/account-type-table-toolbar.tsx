...
import { useBulkDeleteAccountType } from "@/modules/fms/hooks/use-accounting-type"
import { AccountTypeQueryOptions } from "@/modules/fms/types/accounting-types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: AccountTypeQueryOptions
  updateParams?: (newParams: Partial<AccountTypeQueryOptions>) => void
  onClear?: () => void
}
...
export default function AccountTypeTableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const { mutateAsync: bulkDeleteAccountType, isPending: isDeletePending } =
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteAccountType(selectedIds)
  }
