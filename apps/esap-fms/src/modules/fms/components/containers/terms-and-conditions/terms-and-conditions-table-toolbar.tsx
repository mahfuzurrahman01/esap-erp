...
import { useBulkDeleteTermsAndConditions } from "@/modules/fms/hooks/use-terms-and-conditions"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: TermsAndConditionsQueryOptions
  updateParams?: (newParams: Partial<TermsAndConditionsQueryOptions>) => void
  onClear?: () => void
}
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const { mutateAsync: bulkDeleteTermsAndConditions, isPending: isDeletePending } =
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteTermsAndConditions(selectedIds)
  }
