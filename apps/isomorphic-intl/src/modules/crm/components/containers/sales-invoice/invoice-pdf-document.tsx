...
const SalesInvoicePdfDocument = ({ data, salesInvoiceDetails }:any) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.subtitle}>Invoice No #{data.invoiceNo}</Text>
          </View>
          <View>
            <Text style={styles.subtitle}>Invoice Date: {formatDate(data.invoiceDate)}</Text>
            <Text style={styles.subtitle}>Due Date: {formatDate(data.duegDate)}</Text>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          {salesInvoiceDetails?.map((item:any, index:number) => (
        ...
        <View style={styles.summaryContainer}>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.grandTotal}>{data.grandTotal}</Text>
          </View>
        </View>
      </Page>
    </Document>
