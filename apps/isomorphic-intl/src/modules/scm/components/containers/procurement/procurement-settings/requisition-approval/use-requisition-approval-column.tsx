...
import RequisitionApprovalFormDrawerView from "./requisition-approval-drawer-form";
import PaymentTermsDrawerView from "./requisition-approval-drawer-view";
...
const columnHelper = createColumnHelper<RequisitionApproval>()

export const useRequisitionApprovalTableColumns = () => {
