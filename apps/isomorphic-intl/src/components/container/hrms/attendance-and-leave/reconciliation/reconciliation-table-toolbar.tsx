...
import { ReconciliationQueryOptions } from "@/types/hrms/attendance-and-leave/reconciliation.types"
import { Department } from "@/types/hrms/employee/department.types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: ReconciliationQueryOptions
  updateParams?: (newParams: Partial<ReconciliationQueryOptions>) => void
  onClear?: () => void
}
...
export default function ReconciliationTableToolbar<
