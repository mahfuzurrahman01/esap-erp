...
import { recentActivitiesData } from "@/data/crm/crm-dashboard-data"
...
export default function RecentActivities({
  ...
  return (
    <WidgetCard
      title={t("text-recent-activities")}
      ...
      <SimpleBar className="mt-2 max-h-[400px] @4xl:max-h-[400px] @7xl:max-h-[400px]">
