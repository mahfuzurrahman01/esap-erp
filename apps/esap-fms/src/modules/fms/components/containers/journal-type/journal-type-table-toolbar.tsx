...
import { useBulkDeleteJournalEntryType } from "@/modules/fms/hooks/use-journal-entry-type"
import { JournalEntryTypeQueryOptions } from "@/modules/fms/types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: JournalEntryTypeQueryOptions
  updateParams?: (newParams: Partial<JournalEntryTypeQueryOptions>) => void
  onClear?: () => void
}
...
export default function JournalEntryTypeTableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const {
    mutateAsync: bulkDeleteJournalEntryType,
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteJournalEntryType(selectedIds)
  }
