...
import { useBulkDeleteBank } from "@/modules/fms/hooks/use-bank"
...
export default function BankTableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
