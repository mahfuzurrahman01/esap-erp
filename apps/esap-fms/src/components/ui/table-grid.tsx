...
const tableStyles = tv({
  slots: {
    wrapper: "w-full relative overflow-hidden print:overflow-visible print:w-full print:h-auto",
    scrollContainer: [
      "w-full overflow-auto print:overflow-visible",
    ...
    headerCell:
      "px-3 py-5 text-xs font-semibold tracking-wider text-gray-500 uppercase",
...
type UpdateDataFn = (index: number, field: string, value: any) => void
...
const TableGrid = forwardRef<HTMLDivElement, TableProps>(
  (
    ...
    return (
      <div ref={ref} className={cn(styles.wrapper(), className, "table-grid")}>
          ...
          <div className={styles.table()}>
            ...
            <div className={styles.body()}>
              {Array.isArray(filteredData) && filteredData.length > 0 ? (
                ...
                <Empty
                  image={<EmptyProductBoxIcon className="w-[200px] h-[200px]" />}
                  text="No data found"
