...
import { RequisitionApprovalQueryOptions } from "@/modules/scm/types/procurement/requisition/requisition-approval-types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: RequisitionApprovalQueryOptions
  updateParams?: (newParams: Partial<RequisitionApprovalQueryOptions>) => void
  onClear?: () => void
}

export default function RequisitionApprovalTableToolbar<
