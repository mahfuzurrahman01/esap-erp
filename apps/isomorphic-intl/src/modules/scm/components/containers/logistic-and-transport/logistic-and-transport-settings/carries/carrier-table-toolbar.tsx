...
import { CarrierQueryOptions } from "@/modules/scm/types/logistics-and-transport/carriers/carriers-types"


interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: CarrierQueryOptions
  updateParams?: (newParams: Partial<CarrierQueryOptions>) => void
  onClear?: () => void
}

export default function CarrierTableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
