...
import { useBulkDeleteTaxCategory } from "@/modules/fms/hooks/use-tax-category"
import {
...
interface TableToolbarProps<T extends Record<string, any>> {
  ...
  params?: TaxCategoryQueryOptions
  updateParams?: (newParams: Partial<TaxCategoryQueryOptions>) => void
  onClear?: () => void
}
...
export default function TaxCategoryTableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const { mutateAsync: bulkDeleteTaxCategory, isPending: isDeletePending } =
    useBulkDeleteTaxCategory()
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteTaxCategory(selectedIds)
  }
