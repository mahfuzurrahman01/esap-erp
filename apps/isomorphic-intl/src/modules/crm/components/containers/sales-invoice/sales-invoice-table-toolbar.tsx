...
import { SalesInvoiceQueryOptions } from "@/modules/crm/types/sales-invoice"
...
interface TableToolbarProps<T extends Record<string, any>> {
  ...
  params?: SalesInvoiceQueryOptions
  updateParams?: (newParams: Partial<SalesInvoiceQueryOptions>) => void
  onClear?: () => void
}
...
export default function SalesInvoiceTableToolbar<
