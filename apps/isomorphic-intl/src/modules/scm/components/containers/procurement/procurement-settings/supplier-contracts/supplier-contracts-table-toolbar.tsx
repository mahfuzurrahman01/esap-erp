...
import { ContractQueryOptions } from "@/modules/scm/types/procurement/supplier/contract-types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: ContractQueryOptions
  updateParams?: (newParams: Partial<ContractQueryOptions>) => void
  onClear?: () => void
}

export default function SupplierContractsTableToolbar<
