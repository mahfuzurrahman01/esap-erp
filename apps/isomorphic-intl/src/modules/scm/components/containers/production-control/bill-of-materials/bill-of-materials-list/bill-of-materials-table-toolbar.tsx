...
import { BillOfMaterialsQueryOptions } from "@/modules/scm/types/production-control/bill-of-materials/bill-of-materials-type"
import { WorkCenter } from "@/modules/scm/types/production-control/work-order-tracking/work-center-types"

import { billOfMaterialsStatusOptions } from "./status-option"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: BillOfMaterialsQueryOptions
  updateParams?: (newParams: Partial<BillOfMaterialsQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  return (
    <>
      ...
      <Select
        labelClassName="text-title"
        options={billOfMaterialsStatusOptions}
        value={
          billOfMaterialsStatusOptions.find(
        ...
        isLoading={false}
        isDisabled={false}
        placeholder={t("table-text-select-approval-status")}
        className="min-w-[242px]"
...
export default function BillOfMaterialsTableToolbar<
