...
import { WorkCenterQueryOptions } from "@/modules/scm/types/production-control/work-order-tracking/work-center-types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: WorkCenterQueryOptions
  updateParams?: (newParams: Partial<WorkCenterQueryOptions>) => void
  onClear?: () => void
}

export default function WorkCenterTableToolbar<
