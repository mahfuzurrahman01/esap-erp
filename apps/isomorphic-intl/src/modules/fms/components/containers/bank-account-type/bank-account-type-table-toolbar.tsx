...
import { useBulkDeleteBankAccountType } from "@/modules/fms/hooks/use-bank-account-type"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: BankAccountTypeQueryOptions
  updateParams?: (newParams: Partial<BankAccountTypeQueryOptions>) => void
  onClear?: () => void
}
...
export default function BankAccountTypeTableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const { mutateAsync: bulkDeleteBankAccountType, isPending: isDeletePending } =
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteBankAccountType(selectedIds)
  }
