...
import { useBulkDeleteDepartment } from "@/hooks/hrms/employee/use-department"
import { useEmployeeOptions } from "@/hooks/hrms/employee/use-employee"
import { DepartmentQueryOptions } from "@/types/hrms/employee/department.types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: DepartmentQueryOptions
  updateParams?: (newParams: Partial<DepartmentQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const isFiltered = Boolean(params?.search || params?.managerId)
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const {
    mutateAsync: bulkDeleteDepartment,
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteDepartment(selectedIds)
  }
