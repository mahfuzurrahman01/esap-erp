...
export default function RecruitmentPagination({
  ...
  count: number
  updateParams: (params: Partial<RecruitmentQueryOptions>) => void
}) {
  ...
  const options = [
    ...
    { value: 9, label: "9 Positions" },
    { value: 12, label: "12 Positions" },
    { value: 15, label: "15 Positions" },
  ]
    ...
    <div className="flex w-full items-center justify-between px-5 @container">
      <div className="hidden @2xl:block">
        <Text className="dark:text-title">
          {count} {t("text-ongoing-recruitment")}
        </Text>
      </div>
