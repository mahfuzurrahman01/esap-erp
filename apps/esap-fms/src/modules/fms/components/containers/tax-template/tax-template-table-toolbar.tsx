...
import { useBulkDeleteTaxTemplate } from "@/modules/fms/hooks/use-tax-template"
import {
...
interface TableToolbarProps<T extends Record<string, any>> {
  ...
  params?: TaxTemplateQueryOptions
  updateParams?: (newParams: Partial<TaxTemplateQueryOptions>) => void
  onClear?: () => void
}
...
export default function TaxTemplateTableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const { mutateAsync: bulkDeleteTaxTemplate, isPending: isDeletePending } =
    useBulkDeleteTaxTemplate()
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteTaxTemplate(selectedIds)
  }
