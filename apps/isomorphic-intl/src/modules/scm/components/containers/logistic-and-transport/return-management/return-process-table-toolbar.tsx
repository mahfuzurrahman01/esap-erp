...
import { ReturnProcessQueryOptions } from "@/modules/scm/types/logistics-and-transport/return-process/return-process-types"

import { returnStatusOptions } from "./status-option"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: ReturnProcessQueryOptions
  updateParams?: (newParams: Partial<ReturnProcessQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const isFiltered = Boolean(
    params?.search || params?.productName || params?.returnStatus
  )
  ...
  const handleReturnStatusChange = (option: any) => {
    updateParams?.({
       ...
       <Select
        ...
        value={
          returnStatusOptions.find(
            (option) => option.value === params?.returnStatus
          ) || null
        }
...
export default function ReturnProcessTableToolbar<
