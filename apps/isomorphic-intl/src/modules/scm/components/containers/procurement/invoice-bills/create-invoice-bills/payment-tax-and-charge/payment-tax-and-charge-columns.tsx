...
import { TaxTypeList } from "@/modules/fms/types/tax-type"
import {
  paymentAmountAtom,
...
export const usePaymentTaxAndChargeColumns = ({
  ...
  const viewColumns = [
    ...
    },
    {
      ...
      cell: (props: any) => (
        <Text className="font-medium text-gray-900 dark:text-gray-0">
          {props.row.original.rate || props.row.original.taxRate || 0}
        </Text>
      ),
    },
    {
      ...
      cell: (props: any) => (
        <Text className="font-medium text-gray-900 dark:text-gray-0">
          {props.row.original.amount || props.row.original.taxAmount || 0}
        </Text>
      ),
    },
    {
      ...
      cell: (props: any) => (
        <Text className="font-medium text-gray-900 dark:text-gray-0">
          {props.row.original.total || props.row.original.totalAmount || 0}
        </Text>
      ),
    },
  ]
        ...
        },
        {
          ...
          cell: (props: any) => (
            <Input
              ...
              min={0}
              disabled={
                selectedTaxType[props.row.index] === "Actual" || isFieldDisabled || true
              }
            />
          ),
        },
