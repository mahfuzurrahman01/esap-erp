...
import { AttributeQueryOptions } from "@/modules/crm/types/attribute"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: AttributeQueryOptions
  updateParams?: (newParams: Partial<AttributeQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const isFiltered = Boolean(params?.search || params?.name || params?.values)
  return (
    <>
      <Input
        type="text"
...
export default function AttributeTableToolbar<
