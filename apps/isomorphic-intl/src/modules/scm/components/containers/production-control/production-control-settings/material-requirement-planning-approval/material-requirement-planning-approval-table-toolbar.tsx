...
import { MaterialRequirementsPlanApprovalQueryOptions } from "@/modules/scm/types/production-control/materials-requirements-planning/material-requirements-plan-approval-types"
...
interface TableToolbarProps<T extends Record<string, any>> {
  ...
  params?: MaterialRequirementsPlanApprovalQueryOptions
  updateParams?: (
    newParams: Partial<MaterialRequirementsPlanApprovalQueryOptions>
  ) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const isFiltered = Boolean(
    params?.search || params?.approvalStatus || params?.approvedDate
  )
    ...
    <>
      ...
      />
       ...
       <DateFiled
        ...
        selected={params?.approvedDate ? new Date(params.approvedDate) : null}
        onChange={(e: any) => updateParams?.({ approvedDate: e?.toISOString() })}
        autoComplete="off"
      />
...
export default function MaterialRequirementPlanningApprovalTableToolbar<
