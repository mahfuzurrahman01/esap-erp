...
import { useBudgetList, useBulkDeleteBudget } from "@/modules/fms/hooks/use-budget"
import { useCompanyList } from "@/modules/fms/hooks/use-company"
import { BudgetQueryOptions } from "@/modules/fms/types"
...
function FilterElements<T extends Record<string, any>>({
  ...
  const { data: budgetList, isLoading: isBudgetLoading } = useBudgetList()
  ...
  const accountTypeOptions = useUniqueSelectOptions(budgetList?.data, {
    id: "budgetAgainstId",
    name: "budgetAgainst.budgetAgainstName",
  })

  const fiscalYearOptions = useUniqueSelectOptions(budgetList?.data, {
    id: "fiscalYearId",
    name: "fiscalYear.yearRange",
  })
      ...
      <Select
        ...
        value={
          fiscalYearOptions.find(
            (option) => option.value === params?.fiscalYear
          ) || null
        }
