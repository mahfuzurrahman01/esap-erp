...
export default function Sidebar({ className }: { className?: string }) {
  ...
  return (
    <aside
      className={cn(
        "fixed bottom-0 start-0 z-50 h-full w-[270px] border-e-2 border-gray-100 bg-white dark:bg-gray-700 dark:border-gray-700 2xl:w-72",
        className
      )}>
                          ...
                          <div
                            ...
                            className={cn(
                              ...
                              isDropdownOpen
                                ...
                                : "text-gray-700 transition-colors duration-200 hover:bg-gray-100 dark:text-gray-100 dark:hover:text-gray-700"
                            )}>
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          isActive
                            ...
                            : "text-gray-700 transition-colors duration-200 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-100"
                        )}>
                        <div className="flex items-center truncate">
                          {item?.icon && (
                            <span
