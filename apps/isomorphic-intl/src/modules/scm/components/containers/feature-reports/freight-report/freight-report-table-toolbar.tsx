...
import { FreightReportQueryOptions } from "@/modules/scm/types/feature-reports/freight-report"
import dayjs from "dayjs"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: FreightReportQueryOptions
  updateParams?: (newParams: Partial<FreightReportQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  return (
    <>
      ...
      <Input
        type="text"
        placeholder={t("table-text-destination")}
        value={params?.destination}
        onClear={() => updateParams?.({ destination: "" })}
...
export default function FreightReportTableToolbar<
