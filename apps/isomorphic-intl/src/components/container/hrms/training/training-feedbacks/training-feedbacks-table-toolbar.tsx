...
import { useBulkDeleteFeedbacks } from "@/hooks/hrms/training/feedbacks/use-feedbacks"
import { useSessionList } from "@/hooks/hrms/training/session/use-session"
import { useSelectOptions } from "@/hooks/use-select-options"
import { TrainingFeedbackQueryOptions } from "@/types/hrms/training/training-feedbacks-type"
import { TrainingSession } from "@/types/hrms/training/training-session-type"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: TrainingFeedbackQueryOptions
  updateParams?: (newParams: Partial<TrainingFeedbackQueryOptions>) => void
  onClear?: () => void
}

export default function TrainingFeedbackTableToolbar<
