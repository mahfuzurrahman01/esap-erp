...
import { useBulkDeleteSalaryStructures } from "@/hooks/hrms/payroll-configuration/use-salary-structures"
import { SalaryRuleQueryOptions } from "@/types/hrms/payroll-configuration/salary-rules.types"

interface SalaryStructuresTableToolbarProps<T extends Record<string, any>> {
...
function FilterElements<T extends Record<string, any>>({
  ...
  onClear,
}: SalaryStructuresTableToolbarProps<T>) {
...
export default function SalaryStructuresTableToolbar<
  TData extends Record<string, any>,
>({ table, params, updateParams }: SalaryStructuresTableToolbarProps<TData>) {
  const t = useTranslations("table")
  ...
  const {
    mutateAsync: bulkDeleteSalaryStructures,
    isSuccess: deleteSuccess,
    isPending: isDeletePending,
  } = useBulkDeleteSalaryStructures()
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteSalaryStructures(selectedIds)
  }
