...
import { CountryQueryOptions } from "@/modules/fms/types"
...
interface TableToolbarProps<T extends Record<string, any>> {
  ...
  params?: CountryQueryOptions
  updateParams?: (newParams: Partial<CountryQueryOptions>) => void
  onClear?: () => void
}
  ...
  return (
    <>
      {/* <Select
        ...
        value={
          SORT_OPTIONS.find((option) => option.value === params?.sort) ||
          null
        }
...
export default function CountryTableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
