...
import CarrierForm from "@/modules/scm/components/containers/logistic-and-transport/carriers/create-carriers"
...
export default function ShipmentCreateEditFormDrawer({
  ...
  const onSubmit: SubmitHandler<Shipment> = (data) => {
    if (isEditForm) {
      ...
      createShipment({
        ...data,
        stockTransferId: initialData?.id,
      })
    }
  }
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, value } }) => (
                      <Select
                        ...
                        isDisabled={isStockTransferLoading || true}
                        error={
