    ...
    <StickyHeader
      ...
      <div className="hidden items-center gap-3 xl:flex">
        <Link
          ...
          href={"/"}
          className="me-4 hidden w-[155px] shrink-0 text-title lg:me-5 xl:block">
      ...
      <div className="flex w-full items-center justify-between gap-5 xl:w-[calc(100%_-_190px)] 2xl:w-[calc(100%_-_310px)] 3xl:gap-6">
        <div className="flex max-w-2xl items-center xl:w-auto">
          ...
          <Link
            aria-label="Site Logo"
            href="/"
            className="me-4 w-9 shrink-0 text-title lg:me-5 xl:hidden">
        ...
        <div className="flex items-center justify-between gap-2">
          <SearchWidget
            ...
            className="xl:border:none border-none bg-[#f6f7f8] xl:w-auto xl:shadow-none dark:bg-[#afafaf26] mr-2"
