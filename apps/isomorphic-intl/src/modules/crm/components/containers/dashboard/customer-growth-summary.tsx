...
import { useCustomerGrowthList } from "@/modules/crm/hooks/use-customer-growth-reports"
...
export default function CustomerGrowthSummary({
  ...
  const { data: output } = useCustomerGrowthList({
    year: "2025",
  })
  ...
  return (
    <WidgetCard
      ...
      title={t("text-customer-growth-summary")}
      action={
        <DatePicker
          selected={startDate}
