...
import { ItemUnitQueryOptions } from "@/modules/scm/types/procurement/requisition/item-unit-types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: ItemUnitQueryOptions
  updateParams?: (newParams: Partial<ItemUnitQueryOptions>) => void
  onClear?: () => void
}

export default function ItemsTableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
