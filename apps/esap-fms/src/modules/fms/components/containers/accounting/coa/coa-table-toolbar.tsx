...
import { COAQueryOptions } from "@/modules/fms/types/coa"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: COAQueryOptions
  updateParams?: (newParams: Partial<COAQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const isFiltered = Boolean(params?.search || params?.companyId)
...
export default function COATableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
