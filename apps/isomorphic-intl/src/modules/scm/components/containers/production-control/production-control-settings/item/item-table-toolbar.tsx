...
import { ItemQueryOptions } from "@/modules/scm/types/production-control/bill-of-materials/items-types"


interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: ItemQueryOptions
  updateParams?: (newParams: Partial<ItemQueryOptions>) => void
  onClear?: () => void
}

export default function ItemTableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
