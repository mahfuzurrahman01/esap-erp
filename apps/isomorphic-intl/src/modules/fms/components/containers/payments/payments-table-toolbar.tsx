...
import { PaymentQueryOptions } from "@/modules/fms/types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: PaymentQueryOptions
  updateParams?: (newParams: Partial<PaymentQueryOptions>) => void
  onClear?: () => void
}
...
export default function PaymentTableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
