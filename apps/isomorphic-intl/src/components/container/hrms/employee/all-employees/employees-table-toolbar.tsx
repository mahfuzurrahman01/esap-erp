...
interface TableToolbarProps<T extends Record<string, any>> {
  ...
  updateParams?: (newParams: Partial<EmployeeQueryOptions>) => void
  onClear?: () => void
}
...
export default function EmployeesTableToolbars<
...
>({
  ...
  const {
    mutateAsync: bulkDeleteEmployee,
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteEmployee(selectedIds)
  }
    ...
    <div className="flex items-center justify-between px-5">
      ...
      <div className="flex items-center gap-4">
        ...
        <Button
          ...
          <FilterIcon className="me-1.5 h-[18px] w-[18px]" />
          {!isShowingCard
            ? t("table-text-show-card")
            : t("table-text-hide-card")}
        </Button>
