...
import { stockReplenishmentStatusOptions } from "./status-option"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: StockReplenishmentQueryOptions
  updateParams?: (newParams: Partial<StockReplenishmentQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const isFiltered = Boolean(
    params?.search || params?.productName || params?.status
  )
  ...
  return (
    <>
      ...
      <Select
        ...
        options={stockReplenishmentStatusOptions}
        value={
          stockReplenishmentStatusOptions.find(
...
export default function StockReplenishmentTableToolbar<
