...
import { useStockTransferApprovalById } from "@/modules/scm/hooks/inventory/stock-transfer/use-stock-transfer-approval"
...
export default function StockTransferApprovalDrawerView({
  initialData,
}: {
  ...
  const { data, isLoading } = useStockTransferApprovalById(
    Number(initialData?.id)
  )

  // Use useMemo to memoize any derived data if needed
  const memoizedData: StockTransferApproval | undefined = useMemo(
    () => data as StockTransferApproval,
    [data]
  )
  ...
  return (
    <div className="flex h-full flex-col">
      <DrawerHeader
        heading={t("text-stock-transfer-approval-details")}
        onClose={closeDrawer}
