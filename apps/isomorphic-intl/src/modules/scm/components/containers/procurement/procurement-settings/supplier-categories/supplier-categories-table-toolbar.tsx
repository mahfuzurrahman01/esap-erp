...
import { SupplierCategoryQueryOptions } from "@/modules/scm/types/procurement/supplier/supplier-category-types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: SupplierCategoryQueryOptions
  updateParams?: (newParams: Partial<SupplierCategoryQueryOptions>) => void
  onClear?: () => void
}

export default function SupplierCategoryTableToolbar<
