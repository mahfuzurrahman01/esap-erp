...
interface TableToolbarProps<T extends Record<string, any>> {
  ...
  params?: BankTransactionQueryOptions
  updateParams?: (newParams: Partial<BankTransactionQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const { data: bankTransactionList, isLoading: isBankTransactionLoading } = useBankTransactionList()
  ...
  const accountTypeOptions = useSelectOptions<BankAccountList>(bankAccountList?.data, "accountName")

  const statusOptions = useUniqueSelectOptions(bankTransactionList?.data, {
    id: "status",
    name: "status",
  })
  ...
  return (
    <>
      ...
      <Select
        ...
        isDisabled={isBankTransactionLoading}
        placeholder={
...
export default function BankTransactionTableToolbar<TData extends Record<string, any>>({
  table,
  params,
  updateParams,
  ...
  const {
    mutateAsync: bulkDeleteBankTransaction,
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteBankTransaction(selectedIds)
  }
