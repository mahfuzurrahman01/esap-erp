      ...
      <div className="relative w-full px-8 sm:px-12 md:px-16">
        <div className="relative flex w-full items-center justify-center">
          ...
          <div className="absolute -left-8 top-[50%] z-10 -translate-y-1/2 sm:-left-10 md:-left-12">
            <div className="h-12 w-12 animate-pulse rounded-[12px] bg-gray-200 dark:bg-gray-800/50 dark:backdrop-blur-sm sm:h-14 sm:w-14 md:h-16 md:w-16" />
          </div>
            ...
            {Array(cardsToShow)   
              ...
              .map((_, index) => (
                <div key={index} className="w-[90%] sm:w-[48%] lg:w-[35%]">
                  <div
                    className={cn(
                      "relative rounded-[20px] bg-gray-200/80 transition-all dark:bg-gray-800/50 dark:backdrop-blur-sm",
                      "h-[200px] sm:h-[260px] lg:h-[320px]",
                      "p-4 sm:p-5 md:p-6",
                      "flex flex-col"
                    )}>
                    {/* Icon Skeleton */}
                    <div className="mb-3 h-10 w-10 animate-pulse rounded-full bg-gray-300 dark:bg-gray-700/50 sm:h-12 sm:w-12 md:h-14 md:w-14" />

                    <div className="space-y-3">
                      {/* Label Skeleton */}
                      <div className="h-4 w-24 animate-pulse rounded bg-gray-300 dark:bg-gray-700/50 sm:h-5 md:h-6" />

                      {/* Value Skeleton */}
                      <div className="h-8 w-32 animate-pulse rounded bg-gray-300 dark:bg-gray-700/50 sm:h-10 sm:w-40 md:h-12 md:w-48" />

                      {/* Growth Stats Skeleton */}
                      <div className="absolute bottom-4 flex items-center gap-2 sm:bottom-5 md:bottom-6">
                        <div className="h-4 w-4 animate-pulse rounded-full bg-gray-300 dark:bg-gray-700/50 sm:h-5 sm:w-5 md:h-6 md:w-6" />
                        <div className="h-3 w-16 animate-pulse rounded bg-gray-300 dark:bg-gray-700/50 sm:h-4 sm:w-20 md:h-5 md:w-24" />
                      </div>
                    </div>
                  </div>
                </div>
