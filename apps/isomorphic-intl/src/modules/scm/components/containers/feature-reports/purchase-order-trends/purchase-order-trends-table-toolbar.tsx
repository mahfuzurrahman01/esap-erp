...
import { PurchaseOrderTrendsQueryOptions } from "@/modules/scm/types/feature-reports/purchase-order-trends"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: PurchaseOrderTrendsQueryOptions
  updateParams?: (newParams: Partial<PurchaseOrderTrendsQueryOptions>) => void
  onClear?: () => void
}
...
export default function PurchaseOrderTrendsTableToolbar<
