...
import AttributesTable from "@/modules/crm/components/containers/attributes/table"

const AttributeFormDrawerView = dynamic(
  () =>
    import(
      "@/modules/crm/components/containers/attributes/attribute-form-drawer-view"
    ),
  {
    ssr: false,
  }
...
export default function AttributeListTemplate({
  pageHeader,
}: {
