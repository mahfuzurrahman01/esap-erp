...
function FilterElements<T extends Record<string, any>>({
  ...
  const handleStartDate = (date: any) => {
    updateParams?.({
      postingDateFrom: date ? dayjs(date).format("YYYY-MM-DD") : undefined,
    })
  }

  const handleEndDate = (date: any) => {
    updateParams?.({
      postingDateTo: date ? dayjs(date).format("YYYY-MM-DD") : undefined,
    })
  }
    ...
    <>
      ...
      <div className="flex gap-4">
        <DatePicker
          ...
          value={params?.postingDateFrom ? new Date(params.postingDateFrom) : null}
          maxDate={new Date()}
          portal
        />
        <DatePicker
          ...
          value={params?.postingDateTo ? new Date(params.postingDateTo) : null}
          maxDate={new Date()}
          portal
        />
      </div>
