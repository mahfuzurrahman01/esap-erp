...
import { AssetMovementQueryOptions } from "@/modules/fms/types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: AssetMovementQueryOptions
  updateParams?: (newParams: Partial<AssetMovementQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const { company } = useSharedDataHooks([
    "company",
  ])
