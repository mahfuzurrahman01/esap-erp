...
import { AssetMaintenanceQueryOptions } from "@/modules/fms/types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: AssetMaintenanceQueryOptions
  updateParams?: (newParams: Partial<AssetMaintenanceQueryOptions>) => void
  onClear?: () => void
}
