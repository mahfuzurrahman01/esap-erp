...
const badge = tv({
  ...
  compoundVariants: [
    ...
    },
    {
      color: "emerald",
      variant: "flat",
      class: "bg-primary/15 text-primary-dark dark:text-primary-light",
    },
    {
      color: "emerald",
      variant: "outline",
    ...
    },
    {
      color: "gray",
      variant: "outline",
      class: "border border-gray-600 text-gray-600 dark:text-gray-50",
    },
    {
      color: "babypink",
      variant: "solid",
      class: "bg-pink-500 text-pink-50",
    },
    {
      color: "babypink",
      variant: "flat",
    ...
    },
    {
      color: "babypink",
      variant: "outline",
      class: "border border-pink-800 text-pink-800 dark:text-pink-50",
    },
    {
      color: "pending",
      variant: "solid",
    ...
    },
    {
      color: "pending",
      variant: "flat",
      class: "bg-red/15 text-red",
    },
    {
      color: "pending",
      variant: "outline",
      class: "border border-red text-red",
    },
    {
      color: "error",
      variant: "solid",
    ...
    },
    {
      color: "error",
      variant: "flat",
      class: "bg-red-300 text-red-dark",
    },
    {
      color: "error",
      variant: "outline",
      class: "border border-red-dark text-red-dark",
    },
    {
    ...
    },
    {
      color: "secondaryerror",
      variant: "flat",
      class: "bg-red-200 text-red-dark",
    },
    {
      color: "secondaryerror",
      variant: "outline",
    ...
    },
    {
      color: "purple",
      variant: "flat",
      class: "bg-secondary/15 text-secondary-dark",
    },
    {
      color: "purple",
      variant: "outline",
