...
import { AssetDepreciationLedgerQueryOptions } from "@/modules/fms/types"
import { DatePicker } from "@/components/base/date-picker"

interface TableToolbarProps {
  params?: AssetDepreciationLedgerQueryOptions
  updateParams?: (newParams: Partial<AssetDepreciationLedgerQueryOptions>) => void
  onClear?: () => void
  filterValue?: string
...
export default function AssetDepreciationLedgerTableToolbar({
  params,
  updateParams,
  onFilterChange,
}: TableToolbarProps) {
