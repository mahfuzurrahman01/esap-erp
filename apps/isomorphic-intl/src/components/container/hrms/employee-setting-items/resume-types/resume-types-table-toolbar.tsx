...
import { useBulkDeleteResumeType } from "@/hooks/hrms/employee/use-resume-type"
import { ResumeTypeQueryOptions } from "@/types/hrms/employee/resume-types.types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: ResumeTypeQueryOptions
  updateParams?: (newParams: Partial<ResumeTypeQueryOptions>) => void
  onClear?: () => void
}

export default function ResumeTypesTableToolbar<
...
>({ table, params, updateParams }: TableToolbarProps<TData>) {
  ...
  const {
    mutateAsync: bulkDeleteResumeTypes,
    isSuccess: deleteSuccess,
    isPending: isDeletePending,
  } = useBulkDeleteResumeType()
  ...
  const bulkDeleteHandle = () => {
    ...
    bulkDeleteResumeTypes(selectedIds)
  }
