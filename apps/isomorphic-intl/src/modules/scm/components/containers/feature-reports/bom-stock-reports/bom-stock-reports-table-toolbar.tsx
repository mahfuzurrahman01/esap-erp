...
import { BomStockReportsQueryOptions } from "@/modules/scm/types/feature-reports/bom-stock-reports"
import dayjs from "dayjs"
interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: BomStockReportsQueryOptions
  updateParams?: (newParams: Partial<BomStockReportsQueryOptions>) => void
  onClear?: () => void
}
...
function FilterElements<T extends Record<string, any>>({
  ...
  const { product, unit } = useSCMSharedDataHook(["product", "unit"])
  ...
  const handleUnitNameChange = (option: any) => {
    updateParams?.({
  ...
  return (
    <>
      ...
      <Select
        ...
        value={
          unitOptions.find(
            (option: any) => option.label === params?.unitName
          ) || null
        }
