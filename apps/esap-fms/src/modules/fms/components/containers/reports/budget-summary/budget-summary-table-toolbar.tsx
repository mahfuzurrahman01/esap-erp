...
import { BudgetSummaryQueryOptions } from "@/modules/fms/types/budget-summary"
import { useSharedDataHooks } from "@/modules/fms/constants/shared-data-hook"

interface TableToolbarProps {
  params?: BudgetSummaryQueryOptions
  updateParams?: (newParams: Partial<BudgetSummaryQueryOptions>) => void
  onClear?: () => void
  filterValue?: string
      ...
      <Select
        ...
        value={
          fiscalYearOptions.find(
            (option: any) => option.value === params?.fiscalYear
          ) || null
        }
...
export default function BudgetSummaryTableToolbar({
  params,
  updateParams,
  onFilterChange,
}: TableToolbarProps) {
