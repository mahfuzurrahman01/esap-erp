...
import { ProductCategoryQueryOptions } from "@/modules/scm/types/inventory/products/product-category-types"

interface TableToolbarProps<T extends Record<string, any>> {
  table: ReactTableType<T>
  params?: ProductCategoryQueryOptions
  updateParams?: (newParams: Partial<ProductCategoryQueryOptions>) => void
  onClear?: () => void
}

export default function ProductCategoryTableToolbar<
