...
import TasksTable from "@/modules/crm/components/containers/tasks/table"

const TaskDrawerView = dynamic(
  () => import("@/modules/crm/components/containers/tasks/drawer-view"),
  {
    ssr: false,
  }
)
