...
import { AssetMovementHistoryQueryOptions } from "@/modules/fms/types/asset-movement-history"
import { DatePicker } from "@/components/base/date-picker"
import dayjs from "dayjs"

interface TableToolbarProps {
  params?: AssetMovementHistoryQueryOptions
  updateParams?: (newParams: Partial<AssetMovementHistoryQueryOptions>) => void
  onClear?: () => void
  filterValue?: string
...
function FilterElements({ params, updateParams, onClear }: TableToolbarProps) {
  ...
  const isFiltered = Boolean(
    params?.startDate || params?.endDate || params?.purposeOfMovement
  )
  ...
  return (
    <>
      ...
      <Select
        ...
        value={purposeOptions.find((option) => option.label === params?.purposeOfMovement) || null}
        onChange={(option: any) => handlePurposeChange(option?.value || "")}
        placeholder={t("table-text-purpose")}
...
export default function AssetMovementHistoryTableToolbar({
  params,
  updateParams,
  onFilterChange,
}: TableToolbarProps) {
