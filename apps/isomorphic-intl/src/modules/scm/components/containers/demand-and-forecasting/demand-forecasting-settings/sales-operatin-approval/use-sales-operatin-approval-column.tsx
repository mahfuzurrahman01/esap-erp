...
import SalesOperationApprovalFormDrawerView from "./sales-operatin-approval-drawer-form"
import SalesOperationApprovalDrawerView from "./sales-operatin-approval-drawer-view"
import { getListApprovalStatusBadge } from "./status-option"

const columnHelper = createColumnHelper<SalesOperationApproval>()

export const useSalesOperationApprovalTableColumns = () => {
              ...
              <div className="flex items-center justify-end gap-3 pe-3">
                <EditIconButton
                  onClick={() =>
                    openDrawer({
                      view: (
                        <SalesOperationApprovalFormDrawerView
                          isEditForm={true}
                ...
                <ViewIconButton
                  onClick={() => {
                    openDrawer({
                      view: (
                        <SalesOperationApprovalDrawerView
                          initialData={row.original}
                        />
                      ),
